...
export const MobileNav = () => {
  ...
  return (
    <div className='border-border bg-background-primary/95 fixed right-0 bottom-0 left-0 z-50 border-t pt-1 pb-[calc(8px+env(safe-area-inset-bottom))] backdrop-blur-xl md:hidden'>
      <nav
        style={{
